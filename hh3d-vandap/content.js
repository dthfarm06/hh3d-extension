...
class VanDapHelper {
    constructor() {
        ...
        console.log(`[VanDap Helper] Initialized in ${this.isTestMode ? 'TEST' : 'PROD'} mode`);
        console.log(`[VanDap Helper] URL: ${window.location.href}`);
...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    ...
    if (!vanDapHelper) {
        sendResponse({ error: 'VanDapHelper not initialized' });
        return;
    }
